...
- `index.html`, `results.sarif.json`, `results.json` を `data/plugin-reports/builtin.audit-skill-scanner/` 配下に保持します
...
- `sub_artifacts`: `data/plugin-reports/<plugin-id>/<normalized-skill-key>/` 配下に置く共通ファイル名配列
