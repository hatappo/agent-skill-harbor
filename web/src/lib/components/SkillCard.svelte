...
<a
	...
	class="block rounded-lg border border-l-4 border-gray-200 bg-white p-5 shadow-sm transition-shadow hover:shadow-md dark:border-gray-700 dark:bg-gray-900 dark:shadow-gray-900/50 dark:hover:shadow-gray-900/80 {skill.isOrgOwned ? 'border-l-blue-500 dark:border-l-blue-400' : 'border-l-transparent'}"
>
	...
	<div class="mt-3 flex flex-wrap items-center gap-3 text-xs text-gray-500 dark:text-gray-400">
		{#if skill.isOrgOwned}
			<span class="inline-flex items-center gap-1 rounded bg-blue-50 px-1.5 py-0.5 font-medium text-blue-700 dark:bg-blue-900/30 dark:text-blue-300">
		...
		{:else}
			<span class="inline-flex items-center gap-1 rounded bg-gray-100 px-1.5 py-0.5 font-medium text-gray-600 dark:bg-gray-800 dark:text-gray-400">
				<svg class="h-3.5 w-3.5" viewBox="0 0 20 20" fill="currentColor">
